          ...
          <div className="h-auto w-full justify-center">
              ...
              <div className="h-auto w-full justify-center flex bg-gray-200 py-12" ref={userGuideRef}>
                  <div className="w-768 px-5 py-5">
                      ...
                      <div className="bodyText">Cash Flow is a tool to help you quickly setup a discounted cash flow model by just configuring a few settings. If you have a Capital IQ subscription, Cash Flow will automatically import financial information into your model, and even calculate beta and debt ratios based on information from a set of your pre-selected comparable companies.</div>
                      <div className="bodyText">You can download and continue working on the model in Excel. You can amend the settings at any time, and of course overlay additional data and analysis as needed.</div>
                      <div className="bodyText">Before proceeding, a quick disclaimer: <strong>Cash Flow is not meant as a replacement for the analysis that goes into building a valuation model.</strong> The output of your model will, as always, depend on the robustness of your assumptions. </div>
                      <div className="italic bodyText">“A good valuation is 75% art and 25% science."</div>
                      <div className="bodyText">You will need to continue to apply your own expertise and judgement in preparing financial forecasts, estimating an appropriate discount rate, amongst other assumptions.</div>
                      <div className="bg-accent w-12 h-1 mb-8"></div>
                      <div className="text-2xl font-semibold mb-8 pt-4">Instructions</div>
                      <div className="bodyText">Cash Flow is really simple to use.</div>
                      ...
                      <div className="bodyText">If you are not sure what settings to use, or you are just trying out the tool, you can use use the Sample settings built into the page.</div>
                      <div className="bodyText">
                      ...
                      <div className="bodyText">When I used to work as a financial analyst, I would spend way too much time on tedious tasks in Excel, either building models from scratch or auditing them for errors. This was time and energy taken away from focusing on what's most important: understanding companies and the drivers of their value.</div>
                      <div className="bodyText">Cash Flow is a proof of concept for an idea I've had over the last few years: that we can re-use the models we have built in the past and configure them in programmable ways, so we can get back to solving truly interesting problems in our work.</div>
                      <div className="bodyText">
