        ...
        <DefaultLayout>
            ...
            <div className="bg-gray-50 p-5">
                ...
                <div className="bodyTextSmall">
                    Cash Flow is automated valuation tool and analyst training tool that takes the work out of building
                    robust financial models.
                </div>
                <div className="bodyTextSmall">
                    To get the most out of Cash Flow, we recommend first reading this documentation before using the
                    tool. By selecting this level of experience you have indicated that you are an expert in financial
                    modelling and have used Capital IQ extensively in the past. If this is not the case, please go back
                    and make a different selection now.
                </div>
                ...
                <div className="text-xl font-semibold mb-6 pt-4">3 - Building your first financial model</div>
                <div className="bodyTextSmall">
                    <span>
                        Building your first financial model with Cash Flow is as easy as a few clicks. First, head over
                        the the{" "}
                    </span>
                    <Link href="/config" passHref>
                        <span className="text-theme cursor-pointer">Configuration page</span>
                    </Link>
                    <span>
                        {" "}
                        and specify your model inputs and assumptions. The form is broken up into five sections, each of
                        which deal with a specific part of the valuation model.
                    </span>
                </div>
                <div className="bodyTextSmall">
                ...
                <div className="text-xl font-semibold mb-6 pt-4">4 - Downloading your model</div>
                <div className="bodyTextSmall">
                ...
                <div className="text-xl font-semibold mb-6 pt-4">5 - Structure of your model</div>
                <div className="bodyTextSmall">
                ...
                <div className="text-xl font-semibold mb-6 pt-4">6 - Finishing your model in Excel</div>
                <div className="bodyTextSmall">
                ...
                <div className="text-xl font-semibold mb-6 pt-4">7 - Supported devices</div>
                <div className="bodyTextSmall">
