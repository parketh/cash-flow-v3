    ...
    return (
        <DefaultLayout>
            ...
            <div className="bg-gray-50 p-5">
                ...
                <div className="bodyTextSmall">
                    To get the most out of Cash Flow, we recommend first taking our valuation crash course before you
                    get stuck in. Your past experience with financial modelling is going to be super helpful for working
                    through the course material and for using the tool.
                </div>
